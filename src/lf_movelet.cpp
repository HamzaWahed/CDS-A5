...
int main(int argc, char **argv) {
    std::cerr << "usage: load DATASET.ri LF(i) run_F(i)\n";
    ...
    size_t LF_i = atoi(argv[2]);
    size_t run_F_i = atoi(argv[3]);
    ...
    size_t run_LF_i = l;
    while(select_B_L(run_LF_i) < LF_i){
        run_LF_i += 1;
    }
    run_LF_i -= 1;
    ...
    std::cout << "run_LF_i: " << run_LF_i << "\n";
    std::cout << "offset_LF_i: " << offset_LF_i << "\n";
    return 0;
